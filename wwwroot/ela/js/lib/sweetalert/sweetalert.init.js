...
document.querySelector('.sweet-confirm').onclick = function(){
    swal({
            ...
            text: "You will not be able to recover this imagainary file !!",
            type: "warning",
        ...
        function(){
            swal("Deleted !!", "Hey, your imagainary file has been deleted !!", "success");
        });
};
    ...
    swal({
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                swal("Cancelled !!", "Hey, your imagainary file is safe !!", "error");
            }
        });
};
