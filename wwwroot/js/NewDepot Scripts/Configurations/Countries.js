        ...
        columns: [
...

            {
                "render": function (data, type, row) {
                    return "<button class=\"btn btn-sm btn-primary country" + row["countryId"] + "\" id=\"" + row['countryName'] + "\" onclick=\"getCountry(" + row["countryId"] + ")\"> <i class=\"fa fa-edit\"> </i> Edit </button> <a class=\"btn btn-sm btn-danger\" target=\"\" href=\"Countries/Delete/" + row["countryId"] + "\"> <i class=\"fa fa-trash-o\"> </i> Delete </a>";
                }
            }
        ],
